...
import { viewsTrend } from "@/constants/stats";
...
export const TotalViewsLineChart = () => {
  const { theme } = useTheme();
  const primary = theme === "dark" ? "#f97316" : "#f97316";
  const secondary = theme === "dark" ? "#9ca3af" : "#9ca3af";

  return (
    <DashboardCard className="p-6">
      <StatsHeader title="Total Views" amount="+ 112,893" showFilter={false} />
